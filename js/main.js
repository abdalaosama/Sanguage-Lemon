...
function Lamoon(scentence){ // Converts The { scentence } to Sanguage Lemon
...
function randomWord(Letter){// Returns a random Word Starting With the {Letter}
...
function isValid(Word){ // returns True if the word is valid and Lammonable :)
